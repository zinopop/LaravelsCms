                    ...
                    <form role="form" id="search_form">
                        <div class="form-inline">
                            <div class="form-group m-r-xs">
                                <label for="exampleInputEmail2">企业代码简称</label>
                                <input type="text" name="enterprise_short_code" class="form-control">
                            </div>
                            <div class="form-group m-r-xs">
                                <label for="exampleInputEmail2">中文全称</label>
                                <input type="text" name="ch_full_name" class="form-control">
                            </div>
                            <div class="form-group m-r-xs">
                                <label for="exampleInputEmail2">英文全称</label>
                                <input type="text" name="en_full_name" class="form-control">
                            </div>
                            <div class="form-group m-r-xs">
                                <label for="exampleInputEmail2">十位编码</label>
                                <input type="text" name="ten_num" class="form-control">
                            </div>
                            <div class="form-group m-r-xs">
                                <label for="exampleInputEmail2">统一编码</label>
                                <input type="text" name="unified_num" class="form-control">
                            </div>
