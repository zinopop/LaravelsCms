            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form method="get" class="form-horizontal" id="myForm">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">解释</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="mark" value="{{ isset($data['mark']) ? $data['mark'] : ''}}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
        ...
        var saveObj = function () {
            ...
            _saveObj.save = function () {
                ...
                if(validateTips([{
                    ...
                    data:data.mark,
                    message:'解释不能为空',
                    choose:$("#myForm").find("input[name='mark']")
                }]) > 0){
