                ...
                <div class="ibox-content">
                    <form method="get" class="form-horizontal" id="myForm">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">关区代码</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="district_code" value="{{ isset($data['district_code']) ? $data['district_code'] : ''}}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">关区名称</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="district_name" value="{{ isset($data['district_name']) ? $data['district_name'] : ''}}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
    ...
    <script>
        ...
        var saveObj = function () {
            ...
            _saveObj.save = function () {
                ...
                if(validateTips([{
                    data:data.district_code,
                    message:'关区代码不能为空',
                    choose:$("#myForm").find("input[name='district_code']")
                },{
                    data:data.district_name,
                    message:'关区名称不能为空',
                    choose:$("#myForm").find("input[name='district_name']")
                }]) > 0){
