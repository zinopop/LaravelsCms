                ...
                <div class="ibox-content">
                    <form method="get" class="form-horizontal" id="myForm">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">贸易方式代码</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">贸易方式简称</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="short_name" value="{{ isset($data['short_name']) ? $data['short_name'] : ''}}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">贸易方式全称</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="full_name" value="{{ isset($data['full_name']) ? $data['full_name'] : ''}}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
        ...
        var saveObj = function () {
            ...
            _saveObj.save = function () {
                ...
                if(validateTips([{
                    ...
                    message:'贸易方式简称不能为空',
                    choose:$("#myForm").find("input[name='short_name']")
                },{
                    data:data.full_name,
                    message:'贸易方式全称不能为空',
                    choose:$("#myForm").find("input[name='full_name']")
                }]) > 0){
